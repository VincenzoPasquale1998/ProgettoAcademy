    ...
    <section class="ftco-section ftco-no-pt bg-light">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            ...
            <h2 class="mb-2">I nostri veicoli</h2>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-12">
    				...
    				<c:forEach var="automobile" items="${automobili}">
    					<div class="item">
    						<div class="car-wrap rounded ftco-animate">
		    					<div class="img rounded d-flex align-items-end" style="background-image: ${automobile.foto};">
		    					</div>
		    					<div class="text">
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
	          ...
	          <div class="heading-section heading-section-white pl-md-5">
	            ...
	            <p><a href="#" class="btn btn-primary py-3 px-4">Cerca Veicolo</a></p>
	          </div>
					</div>
				</div>
			</div>
		...
		<section class="ftco-section">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-3">I Nostri ultimi servizi</h2>
          </div>
        </div>
				<div class="row">
					<div class="col-md-3">
            	...
            	<div class="text w-100">
                <h3 class="heading mb-2">Matrimoni</h3>
                <p>Rendi indimenticabile il giorno del tuo matrimonio con il nostro esclusivo servizio di noleggio auto. Perfette per aggiungere un tocco di eleganza e stile al tuo matrimonio.</p>
              </div>
            </div>
					</div>
					<div class="col-md-3">
                ...
                <p>Offriamo soluzioni di trasporto affidabili e puntuali da e per l'aeroporto, assicurandoti un viaggio senza stress fin dall'inizio
                  .</p>
              </div>
            </div>
					</div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-3">Clienti soddisfatti</h2>
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              ...
              <div class="item">
                <div class="testimony-wrap rounded text-center py-4 pb-5">
                  ...
                  <div class="text pt-4">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <p class="name">Domenico Latanza</p>
